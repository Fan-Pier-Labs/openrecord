 ...
 *   the CLI's slice sorting): a throw falls back to text-based photometric
 *   detection / download order. The image still renders; only windowing or
 *   slice order degrades, and the fallback logs itself.
 *
