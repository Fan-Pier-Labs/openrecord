...
## Key Files
- `src/main/scrapers/myChart/eunity/imagingDownloader.ts` — Playwright-based downloader (v3)
- `src/main/scrapers/myChart/eunity/imagingViewer.ts` — FDI/SAML chain
- `src/cli.ts` — CLI integration (`--action get-imaging`)
- `src/main/scrapers/myChart/eunity/docs/DICOM_DOWNLOAD_NOTES.md` — detailed reverse engineering notes
