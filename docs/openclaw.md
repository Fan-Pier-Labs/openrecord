...
- **Setup**: `openclaw openrecord setup` — interactive credential config with optional browser password import and TOTP setup
- **Status**: `openclaw openrecord status` — show current config
- **Reset**: `openclaw openrecord reset` — clear saved credentials
