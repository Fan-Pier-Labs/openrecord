...
function buildSystemPrompt(
  ...
  return [
    ...
    "- Message attachments (a photo or PDF on a message): get_messages and get_message_thread list each message's attachments with a dcsId. Call get_message_attachment with the conversation_id and that dcsId as attachment_id. An image comes back as { image_id, caption } — place [image:IMAGE_ID] in your reply as with X-rays. Other file types cannot be shown in this app yet; say so and point the user to the desktop extension or CLI.",
