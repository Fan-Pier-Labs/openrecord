  ...
  return (
    <div className="min-h-screen text-slate-900" style={{ fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, sans-serif" }}>
        ...
        <div className="max-w-6xl mx-auto pointer-events-auto">
          <div className="relative backdrop-blur-xl bg-white/70 border border-white/40 shadow-[0_8px_30px_rgba(0,0,0,0.04)] rounded-full px-2 py-2 pl-6 flex items-center justify-between transition-all duration-500 hover:bg-white/80 hover:shadow-[0_15px_40px_rgba(0,0,0,0.08)]">
            ...
            <nav className="hidden md:flex items-center gap-1 absolute left-1/2 -translate-x-1/2">
              ...
              <a href="#signin" className="px-4 py-2 text-xs font-medium text-slate-500 hover:text-slate-900 uppercase tracking-wider rounded-full hover:bg-white/60 transition-all">
                Security
              </a>
            </nav>
      ...
      <main className="z-10 w-full relative">
        ...
        {/* Auth Form Section */}
        <section id="signin" className="bg-white/80 backdrop-blur-md py-20 sm:py-28 border-t border-slate-200">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                {authMode === "signin" ? (
                  ...
                  <>
                    <Button className="w-full bg-blue-600 hover:bg-blue-500" onClick={handleEmailSignUp}>
                      Create Account
                    </Button>
                    <p className="text-center text-sm text-slate-500">
              ...
              >
                ...
                <ul className="space-y-3 mb-6">
                  ...
                  <li className="flex items-start gap-2 text-sm text-slate-600">
                    ...
                    <span>Requires Railway account &amp; setup</span>
                  </li>
                </ul>
