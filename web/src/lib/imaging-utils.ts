/**
 * Returns true if the imaging study is a modality we don't yet support
 * viewing in the web UI. CT scans and X-rays are supported via the
 * two-phase AMF init (serviceInstance re-negotiation).
 */
