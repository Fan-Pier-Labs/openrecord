    ...
    params: [
      {
        ...
        description:
          ...
          'care team\'s NationalProviderID came back Epic-encrypted on the instance probed, and ' +
          "get_care_team's derived `npi` is null there. Turn a provider name into an NPI with " +
          'search_npi_registry.',
        required: true,
      },
    ],
